    ...
    try {
      ...
      if (res.success) {
        ...
        if (resumeList.length > 0) {
          // Find the most recent resume (usually index 0 from backend, or sort by upload_date DESC)
          ...
          // Redirect immediately to the cover-letter tab of the latest resume
          navigate(`/resume-result/${latestId}?tab=cover-letter`, { replace: true });
        }
      } else {
    ...
    <Layout>
      <div className="p-6 md:p-8 bg-gradient-to-br from-slate-50 to-indigo-50 dark:from-navy-900 dark:to-charcoal-900 min-h-screen flex items-center justify-center">
        <div className="max-w-md w-full">
          ...
          >
            <div className="w-16 h-16 bg-gradient-to-tr from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm mb-6 leading-relaxed">
              {error ? error : "You don't have any uploaded resumes yet. To generate a personalized, ATS-friendly cover letter, please upload your resume first."}
            </p>
