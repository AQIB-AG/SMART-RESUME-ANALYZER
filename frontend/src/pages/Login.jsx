        ...
        >
          <div className="glass bg-white/80 dark:bg-charcoal-800/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-charcoal-700/50">
            ...
            >
              ...
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2 font-heading">Welcome Back!</h1>
            ...
            >
              ...
              <div>
                ...
                <div className="mt-3 text-right">
                  <Link to="#" className="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors font-medium">
                    Forgot password?
                  </Link>
                </div>
              </div>
